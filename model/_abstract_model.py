...
class SequentialRecModel(nn.Module):
    def __init__(self, args):
        ...
        self.args = args
        # reserve for potential use
        # 0 for padding, [1, args.item_size] for item_id, >= args.item_size+1 for reserved ids
        self.item_embeddings = nn.Embedding(args.item_size+10, args.hidden_size, padding_idx=0)
        self.position_embeddings = nn.Embedding(args.max_seq_length+args.num_future_steps, args.hidden_size)
        self.batch_size = args.batch_size
        self.future_id = args.item_size+1
